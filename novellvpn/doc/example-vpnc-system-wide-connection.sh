...
NAME="novellvpn-system-wide"
ESCAPED_NAME="novellvpn-system-wide"
REMOTE="1.2.3.4"
CA="/etc/novellvpn/CA.crt"
CERT="/etc/novellvpn/thisclient.crt"
KEY="/etc/novellvpn/thisclient.key"
...
gconftool-2 $GCONFTOOL2_OPTS --type string --set $GCONF_PATH/service_name "org.freedesktop.NetworkManager.novellvpn"
